...
function Make(Form) {
  ...
  var debounce = function (wait, validate) {
    var fn = function (param) {
      var dispatch = param[2];
      var input = param[1];
      var field = param[0];
      var __x = Curry._1(validate, input);
  ...
  var getInitialState = function (input) {
    return {
            ...
            validators: {
              contents: Belt_List.reduce(Form.validators, Belt_Map.make(FieldId), (function (validators, validator) {
                      return Belt_Map.set(validators, validator.field, {
                                  field: validator.field,
                                  strategy: validator.strategy,
                                  dependents: validator.dependents,
                                  validate: validator.validate,
                                  validateAsync: Belt_Option.map(validator.validateAsync, (function (param) {
                                          return [
                                                  debounce(Form.debounceInterval, param[0]),
                                                  param[1]
                                                ];
                                        }))
                                });
                    ...
                    switch (exit) {
                      case 1 :
                          ...
                          if (result._0) {
                            ...
                            if (match$6 !== undefined) {
                              var validateAsync = match$6[0];
                              return {
                                      TAG: /* UpdateWithSideEffects */1,
                                      _0: {
                                        input: input,
                                        status: state.status,
                                        fields: Belt_Map.set(fields$1, field, /* Validating */1),
                                        validators: state.validators,
                                        submittedOnce: state.submittedOnce
                                      },
                                      _1: (function (param) {
                                          return Curry._1(validateAsync, [
                                                      field,
                                                      input,
                                                      param.dispatch
                                                    ]);
                      ...
                      case 3 :
                          ...
                          if (result.TAG === /* Ok */0 && !result._0) {
                            ...
                            return {
                                    ...
                                    _1: (function (param) {
                                        return Curry._1(validateAsync$1, [
                                                    field,
                                                    input,
                                                    param.dispatch
                                                  ]);
                      ...
                      if (exit$6 === 2) {
                        ...
                        if (result$1.TAG === /* Ok */0 && !result$1._0) {
                          ...
                          return {
                                  ...
                                  _1: (function (param) {
                                      return Curry._1(validateAsync$2, [
                                                  field$1,
                                                  state.input,
                                                  param.dispatch
                                                ]);
...
var defaultDebounceInterval = 700;
